...
public class FileIO {
	...
	// A file path and name must be given to load a file
	...
	// We can just as easily save the huffman values into a new file instead of 
	// just printing them out to the screen
